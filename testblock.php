...
function my_block_scripts() {
	wp_enqueue_style( 'my-block-editor-style', get_template_directory_uri() . '/src/editor.css', array(), '1.0.0', 'all' );
  }
  add_action( 'enqueue_block_editor_assets', 'my_block_scripts' );
/**
